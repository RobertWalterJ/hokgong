...
function aboutScreen() {
  ...
  return [header('About'), h('main', {},
    ...
    h('section', { class: 'card' },
      ...
      src('Hambaanglaang 冚唪唥',
        'A series of 229 graded Cantonese readers, levels 1 to 7. Their 116,835 word-by-word glosses say what each word MEANS IN A SENTENCE, counted up into a usage table — 係 is used as "is" 930 times and never as "to bind". Nothing here is shown to you as a meaning: it decides which of the dictionaries’ meanings you are taught.',
        'CC BY 4.0 · hambaanglaang.hk · data build by chinvocab.com'),
      src('Tatoeba',
